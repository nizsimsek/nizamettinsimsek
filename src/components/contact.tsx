...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      >
        <input
          className="h-14 px-4 rounded-lg border border-black/10 dark:border-white/10 bg-white text-gray-900 dark:bg-white/20 dark:text-white dark:focus:bg-white/10 transition-all dark:outline-none"
          name="senderEmail"
          type="email"
          required
          maxLength={500}
        ...
        />
        <textarea
          className="h-52 my-3 rounded-lg resize-none border border-black/10 dark:border-white/10 p-4 bg-white text-gray-900 dark:bg-white/20 dark:text-white dark:focus:bg-white/10 transition-all dark:outline-none"
          name="message"
